...
const signupAction = (prevFormState, formData) => {
  ...
  if (!isNotEmpty(password) || !hasMinLength(password))
    errors.push("You must provide password at least six chatacters")
  ...
  if (!terms)
    errors.push("You must agree to the terms and condoitions")
  ...
  return (
    <form action={formAction}>
      ...
      <fieldset>
        ...
        <div className="control">
          <input type="checkbox" id="other" name="acquisition" value="other" defaultChecked={formState.enteredValues?.terms} />
